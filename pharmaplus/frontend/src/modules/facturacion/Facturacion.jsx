                          ...
                          <tr key={item.product_id} className="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td className="py-3.5 px-3 text-center">
                              <input
                                ...
                                step="0.01"
                                min="0"
                                className="w-16 px-2 py-1 text-center bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-800 focus:outline-none focus:border-indigo-600"
